...
def test_filer_15_percent_wht() -> None:
    # 1,000 shares @ 10 Rs. DPS = 10,000 Rs. Gross
    shares = Quantity(Decimal("1000"))
    dps = Money(Decimal("10.00"), "Rs.")
...
def test_custom_wht_with_zakat() -> None:
    ...
    dps = Money(Decimal("20.00"), "Rs.")  # 10,000 Rs. Gross
    zakat = Money(Decimal("250.00"), "Rs.")
