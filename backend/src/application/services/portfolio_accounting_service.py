...
class PortfolioAccountingService:
    ...
    def update_transaction(
        ...
        updated_tx = Transaction(
            ...
            price_per_share=Money(price_per_share, "Rs.") if price_per_share > 0 else existing_tx.price_per_share,
            brokerage_fee=Money(brokerage_fee, "Rs."),
            regulatory_fee=Money(regulatory_fee, "Rs."),
    ...
    def record_transaction(
        ...
        tx = Transaction(
            ...
            price_per_share=Money(price_per_share, "Rs."),
            brokerage_fee=Money(brokerage_fee, "Rs."),
            regulatory_fee=Money(regulatory_fee, "Rs."),
    ...
    def transfer_shares_between_portfolios(
        ...
        tx_out = Transaction(
            ...
            symbol=sym,
            quantity=Quantity(quantity),
            price_per_share=Money(effective_cost_per_share, "Rs."),
            regulatory_fee=Money(cdc_transfer_fee, "Rs."),
